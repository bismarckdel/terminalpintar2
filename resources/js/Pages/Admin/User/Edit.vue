  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <main class="p-8 max-w-4xl mx-auto">
      <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-green-600 mb-2">Edit Pengguna</h1>
        <p class="text-gray-600 text-sm">Ubah informasi pengguna sistem.</p>
      </div>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p class="text-sm text-blue-700">
              <strong>Catatan:</strong> Password tidak dapat diubah melalui halaman ini. Untuk mengubah password, hubungi administrator sistem.
            </p>
          </div>
...
const handleSubmit = () => {
  ...
  form.post(`/admin/user/${props.editUser.id}/update`, {
    preserveScroll: true,
  });
};
</script>
