  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <main class="p-8 max-w-4xl mx-auto">
      <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-green-600 mb-2">Tambah Berita Baru</h1>
        <p class="text-gray-600 text-sm">Isi form di bawah untuk menambahkan berita atau dokumentasi kegiatan.</p>
      </div>
